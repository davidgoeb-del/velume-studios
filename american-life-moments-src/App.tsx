    ...
    >
      ...
      {showPaywall && (() => {
        const pw: Record<string, {
          ...
          'ja': {
            title: 'Lumoraを解放しよう',
            subtitle: '買い切り・永久アクセス。本当の英語の旅は、ここから始まります。',
            feature1: '150の全ネイティブ音声ストーリー',
            feature2: '500以上の実用的な日常英会話フレーズ',
            feature3: '全Lo-Fiサウンドスケープ（買い切り・追加請求なし）',
            lifetimeBtn: 'Lumora 永久アクセス',
            lifetimeSuffix: '（買い切り）',
            ...
            cta: '永久アクセスをアンロック',
            processing: '処理中...',
            footer: '1回のお支払いで永久にご利用いただけます。追加料金は一切ありません。',
            restore: '購入を復元する',
            disclaimer: '購入の確認時にお使いのApple IDアカウントに請求されます。本商品は一度の購入で永久にご利用いただける買い切り（非消費型）アイテムです。定期的な自動更新や追加料金は一切発生しません。すべてのiOS端末で購入を復元できます。'
          },
          'zh-TW': {
            title: '解鎖 Lumora',
            subtitle: '一次購買，永久擁有。真正的英語之旅從這裡開始。',
            feature1: '150多個母語語音故事',
            feature2: '500多個日常英語會話短語',
            feature3: '所有Lo-Fi音樂與文化解說（買斷無訂閱）',
            lifetimeBtn: 'Lumora 永久暢享',
            lifetimeSuffix: '（買斷制）',
            ...
            cta: '解鎖永久版',
            processing: '處理中...',
            footer: '一次付費，永久使用。無任何訂閱費用。',
            restore: '恢復購買',
            disclaimer: '確認購買時將向您的 Apple ID 帳戶收取費用。本商品為一次性購買（非消耗型）項目，可永久使用。無自動續訂或任何額外收費。'
          },
          'zh-CN': {
            title: '解锁 Lumora',
            subtitle: '一次购买，终身可用。真正的英语之旅从这里开始。',
            feature1: '150多个母语语音故事',
            feature2: '500多个日常英语会话短语',
            feature3: '所有Lo-Fi音乐与文化解说（买断无订阅）',
            lifetimeBtn: 'Lumora 终身版',
            lifetimeSuffix: '（一次性买断）',
            annualBtn: 'Lumora 年度方案',
            monthlyBtn: 'Lumora 月度方案',
            annualSuffix: ' / 年',
            monthlySuffix: ' / 月',
            cta: '解锁终身版',
            processing: '处理中...',
            footer: '一次付费，终身使用。无任何后续费用。',
            restore: '恢复购买',
            disclaimer: '确认购买时将向您的 Apple ID 账户收取费用。本商品为一次性购买（非消耗型）项目，可永久使用。无自动续订或任何额外费用。'
          },
          'ko': {
            title: 'Lumora 평생 이용권',
            subtitle: '한 번의 결제로 평생 소장. 추가 구독료 없음.',
            feature1: '150개 이상의 원어민 음성 스토리',
            feature2: '500개 이상의 일상 영어 회화 표현',
            feature3: '모든 Lo-Fi 사운드와 문화 해설 (평생 무제한)',
            lifetimeBtn: 'Lumora 평생 이용권',
            lifetimeSuffix: ' (평생 소장)',
            ...
            cta: '평생 이용권 잠금 해제',
            processing: '처리 중...',
            footer: '한 번의 결제로 평생 소장. 추가 비용 없음.',
            restore: '구매 복원',
            disclaimer: '구매 확인 시 Apple ID 계정으로 결제됩니다. 본 상품은 일회성 구매(비소모성) 상품으로 평생 영구적으로 이용 가능하며 자동 갱신이나 추가 비용이 발생하지 않습니다.'
          },
          'th': {
            title: 'ปลดล็อก Lumora ตลอดชีพ',
            subtitle: 'ชำระครั้งเดียว ใช้งานได้ตลอดชีพ ไม่มีการเรียกเก็บเงินซ้ำ',
            feature1: 'เรื่องราวเสียงเจ้าของภาษา 150 เรื่อง',
            feature2: 'วลีภาษาอังกฤษในชีวิตประจำวันกว่า 500 วลี',
            feature3: 'เพลง Lo-Fi และคำอธิบายวัฒนธรรมทั้งหมด',
            lifetimeBtn: 'Lumora ตลอดชีพ',
            lifetimeSuffix: ' (ชำระครั้งเดียว)',
            ...
            footer: 'ชำระครั้งเดียว ไม่มีค่าบริการรายเดือน/รายปี',
            restore: 'กู้คืนการซื้อ',
            disclaimer: 'การชำระเงินจะถูกเรียกเก็บจากบัญชี Apple ID ของคุณเมื่อยืนยันการสั่งซื้อ สินค้านี้เป็นการซื้อครั้งเดียว (ไม่สิ้นเปลือง) เพื่อเข้าใช้งานตลอดชีพ ไม่มีการต่ออายุอัตโนมัติ'
          },
          'vi': {
            title: 'Mở khóa Lumora Trọn đời',
            subtitle: 'Thanh toán một lần, sở hữu vĩnh viễn. Không phí gia hạn.',
            feature1: 'Toàn bộ 150 câu chuyện âm thanh bản ngữ',
            feature2: 'Hơn 500 cụm từ tiếng Anh giao tiếp thực tế',
            feature3: 'Trọn bộ âm nhạc Lo-Fi và góc nhìn văn hóa',
            lifetimeBtn: 'Lumora Trọn Đời',
            lifetimeSuffix: ' (Mua một lần)',
            annualBtn: 'Lumora Gói Năm',
            monthlyBtn: 'Lumora Gói Tháng',
            annualSuffix: ' / năm',
            monthlySuffix: ' / tháng',
            cta: 'Mở khóa Trọn đời',
            processing: 'Đang xử lý...',
            footer: 'Thanh toán một lần. Không phí ẩn hay gia hạn.',
            restore: 'Khôi phục mua hàng',
            disclaimer: 'Thanh toán sẽ được tính vào tài khoản Apple ID của bạn khi xác nhận mua hàng. Đây là giao dịch mua một lần (không tiêu hao) sử dụng vĩnh viễn, không tự động gia hạn.'
          },
          'en': {
            title: 'Unlock Lumora',
            subtitle: 'One-time payment. Yours to keep forever.',
            feature1: '150+ Native Audio Stories',
            feature2: '500+ Daily English Phrases',
            feature3: 'All Ambient Lo-Fi Music & Cultural Insights',
            lifetimeBtn: 'Lumora Lifetime Access',
            lifetimeSuffix: ' (One-Time Payment)',
            ...
            footer: 'One-time purchase. No subscriptions. No recurring fees.',
            restore: 'Restore Purchases',
            disclaimer: 'Payment is charged to your Apple ID account at confirmation of purchase. This is a one-time non-consumable purchase with no recurring fees or automatic renewals. You can restore your purchase anytime on any iOS device.'
          }
        };
            ...
            <div className="relative w-full max-w-[440px] bg-gradient-to-b from-[#fdfaf5] to-[#f4eee6] rounded-t-[32px] sm:rounded-[32px] shadow-[0_20px_60px_-10px_rgba(40,36,32,0.25)] overflow-hidden animate-slide-up-fade border border-white/60 pt-8 pb-8 px-6 sm:px-8 text-center mt-auto sm:mt-0">
              ...
              <div className="flex flex-col gap-3 relative z-10 w-full sm:w-[90%] mx-auto pb-2">
                {packages.length > 0 ? packages.map((pkg, idx) => {
                  const isLifetime = pkg.identifier === '$rc_lifetime' || pkg.packageType === 'LIFETIME' || pkg.identifier.toLowerCase().includes('lifetime');
                  const isAnnual = pkg.identifier === '$rc_annual' || pkg.packageType === 'ANNUAL';
                  const title = isLifetime ? t.lifetimeBtn : (isAnnual ? t.annualBtn : t.monthlyBtn);
                  const suffix = isLifetime ? t.lifetimeSuffix : (isAnnual ? t.annualSuffix : t.monthlySuffix);
                  return (
                    <button
                      key={pkg.identifier}
                      ...
                      className="w-full h-[58px] rounded-full bg-stone-900 text-white font-sans font-bold text-[15px] sm:text-[16px] tracking-wide hover:scale-[1.02] active:scale-[0.98] hover:bg-stone-800 transition-all shadow-[0_8px_20px_-4px_rgba(40,36,32,0.3)] cursor-pointer flex items-center justify-center gap-2 disabled:opacity-60 disabled:scale-100 disabled:cursor-not-allowed"
                    >
                      {isUnlocking ? (
